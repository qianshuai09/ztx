<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"themes/admin_simpleboot3/admin/active/edit_job.html";i:1535423844;s:85:"/www/web/ztx_hfxyzq_cn/public_html/public/themes/admin_simpleboot3/public/header.html";i:1533800384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li><a href="<?php echo url('active/addJob'); ?>">添加单位</a></li>
    </ul>

    <form action="<?php echo url('Active/editJobPost'); ?>" method="post" id="form" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                    ...
                    <th>标志岗位</th>
                        <td >
                           <input class="form-control" type="text" name="pwork"
                                   id="pwork" required value="<?php echo $result['pwork']; ?>" placeholder=""/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                           <input class="form-control" type="text" name="pdetail"
                                   id="pdetail" required value="<?php echo $result['pdetail']; ?>" placeholder=""/>
                        </td>
                    </tr>
