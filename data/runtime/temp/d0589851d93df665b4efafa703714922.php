<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"themes/admin_simpleboot3/portal/admin_article/edit.html";i:1533800384;s:85:"/www/web/ztx_hfxyzq_cn/public_html/public/themes/admin_simpleboot3/public/header.html";i:1533800384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            <div class="checkbox">
                                <label>
                                    <input  type="checkbox" id="post-status-checkbox" name="post[post_status]" value="1" <?php echo $status_yes; ?>>发布
                    ...
                    <tr>
                        <td>
                            <div class="checkbox">
                                <label><input type="checkbox" id="is-top-checkbox" name="post[is_top]" value="1" <?php echo $is_top_yes; ?>>置顶</label>
                    ...
                    <tr>
                        <td>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" id="recommended-checkbox" name="post[recommended]" value="1" <?php echo $recommended_yes; ?>>推荐
