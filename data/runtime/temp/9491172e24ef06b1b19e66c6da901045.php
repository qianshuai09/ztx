<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"themes/admin_simpleboot3/admin/apply/station.html";i:1536646301;s:85:"/www/web/ztx_hfxyzq_cn/public_html/public/themes/admin_simpleboot3/public/header.html";i:1533800384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <!--  <form class="well form-inline margin-top-20" method="post" action="<?php echo url('AdminPage/index'); ?>">
    ...
    <form class="js-ajax-form" method="post">
       ...
       ?>
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <tr>
                ...
                <th>操作</th>
                 ...
                 <?php if(is_array($muser) || $muser instanceof \think\Collection || $muser instanceof \think\Paginator): if( count($muser)==0 ) : echo "" ;else: foreach($muser as $key=>$vo): ?>
                <tr>
                   
                    <td><?php echo $vo['mu_id']; ?></td>
                    ...
                    <td><?php echo $vo['create_time']; ?></td>
                      ...
                      <td>
                         ...
                         <a href="<?php echo url('apply/deleteApply',array('id'=>$vo['mu_id'])); ?>" class="js-ajax-delete"><?php echo lang('DELETE'); ?></a>
                         <a href="<?php echo url('Apply/replyWork',array('id'=>$vo['mu_id'])); ?>" class="">回复</a>
                    </td>
                </tr>
        ...
        <div class="pagination" ><?php echo $muser->render(); ?></div>
    </form>
</div>
