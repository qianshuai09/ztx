<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"themes/admin_simpleboot3/admin/active/activeedit.html";i:1537668538;s:85:"/www/web/ztx_hfxyzq_cn/public_html/public/themes/admin_simpleboot3/public/header.html";i:1533800384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    ...
    <form action="<?php echo url('Active/editActivePost'); ?>" method="post" id="form" class="form-horizontal js-ajax-form  margin-top-20">
        <div class="row">
            <div class="col-md-9">
                    ...
                    <tr>
                        ...
                        <td >
                            <input class="form-control" type="text" name="pname"
                                   id="pname" required value="<?php echo $product['pname']; ?>" placeholder="" />
                    ...
                    <tr>
                        ...
                        <td >
                            <input class="form-control" type="text" name="ptitle"
                                   id="ptitle" required value="<?php echo $product['ptitle']; ?>" placeholder=""/>
                        </td>
                    </tr>
                    <tr>
                    <th>活动时间</th>
                        <td >
                           <input class="form-control" type="text" name="atime"
                                   id="atime" required value="<?php echo $product['atime']; ?>" placeholder=""/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                           <input class="form-control" type="text" name="alocation"
                                   id="alocation" required value="<?php echo $product['alocation']; ?>" placeholder=""/>
                        </td>
                    </tr>
                    <tr>
                        <th>活动备注</th>
                        <td><input class="form-control" type="text" name="abeizhu"
                                   id="abeizhu" required value="<?php echo $product['abeizhu']; ?>" placeholder=""/></td>
                    </tr>
                    <tr>
                        <th>活动详情图</th>
                        <td>
                              ...
                              <ul id="photos" class="pic-list list-unstyled form-inline">
                                <?php if(!(empty($photo) || (($photo instanceof \think\Collection || $photo instanceof \think\Paginator ) && $photo->isEmpty()))): if(is_array($photo) || $photo instanceof \think\Collection || $photo instanceof \think\Paginator): if( count($photo)==0 ) : echo "" ;else: foreach($photo as $key=>$vo): $img_url=cmf_get_image_preview_url($vo['url']); ?>
                         ...
                         <td>
                            <div style="text-align: center;">
                                <input type="hidden" name="pimg" id="thumbnail"
                                       value="<?php echo $product['pimg']; ?>">
                                <a href="javascript:uploadOneImage('图片上传','#thumbnail');">
                                    <?php if(empty($product['pimg'])): ?>
                                        <img src="/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png"
                                             id="thumbnail-preview"
                                             width="135" style="cursor: pointer"/>
                                        <?php else: ?>
                                        <img src="<?php echo cmf_get_image_preview_url($product['pimg']); ?>"
                                             id="thumbnail-preview"
                                             width="135" style="cursor: pointer"/>
                                    <?php endif; ?>
                                </a>
