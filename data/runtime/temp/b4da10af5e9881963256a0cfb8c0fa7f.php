<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/admin/active/job.html";i:1535423227;s:85:"/www/web/ztx_hfxyzq_cn/public_html/public/themes/admin_simpleboot3/public/header.html";i:1533800384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('active/job'); ?>">单位列表</a></li>
     ...
     <!--      <th>岗位数</th>-->
                ...
                <tr>
                   <!-- <td>
                    ...
                    <td><?php echo $vo['pwork']; ?></td>
                    <td><a href="<?php echo cmf_get_image_preview_url($vo['pimg']); ?>" target="_blank">查看图片</a></td>
                   <!-- <td></td>-->
                  
                  
                      <td>
                        <a href="<?php echo url('active/editJob',array('id'=>$vo['pid'])); ?>"><?php echo lang('EDIT'); ?></a>
