<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"themes/admin_simpleboot3/admin/apply/reply_work.html";i:1536664796;s:85:"/www/web/ztx_hfxyzq_cn/public_html/public/themes/admin_simpleboot3/public/header.html";i:1533800384;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    ...
    <form action="<?php echo url('Apply/replyWorkPost'); ?>" method="post" id="form" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>回复内容</th>
                        <td >
                            <input class="form-control" type="text" name="mu_back"
                                   id="pname" required value="<?php echo $muser['mu_back']; ?>" placeholder=""/>
                            <input type="hidden" name="muid" value="<?php echo $muser['mu_id']; ?>">
                        </td>
                    </tr>
